/*
11 0,1,2,9 * * * https://github.com/Mrsun01/BS
 */
const $ = new Env('④李志豪---盐工健康上报');
...
$.Sessionid = [
  "9pktho9xfre7tq8xvvhxqfngron6zc8v"
]
$.Csrftoken = [
  "IIFVfgeQzKATlpZmWOfpRhLs4k2osF1pzaSQgHd2KApvcTdtwo4OcbviAOJn1UVs"
]
$.Xcsrftoken = [
  "e6oyAlfVKF0sZUb56JnO9F1l0WxVXmFw5yBtBMe7VvP4QopcGjcduzLbwqeUwBzz"
]
    ...
    $.post({
      ...
      try {
        if (err) {
          ...
          await notify.sendNotify("盐工健康日报", ""  + `${$.name}`+ "\n"+ "出错了，快去检查一下吧❗❗❗❗")
        } else {
          $.log(data)
          data = JSON.parse(data);
          var A = unescape(data.msg);
          $.log("盐工健康日报", ""  + `${$.name}`+ "\n"+ A)
          await notify.sendNotify("盐工健康日报", ""  + `${$.name}`+ "\n"+ A)
        }
      } catch (e) {
